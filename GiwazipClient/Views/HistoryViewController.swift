...
//            let asDate = extractDate(networkManager.roomData!.endDate, networkManager.roomData!.warrantyTime)
//            asView.asDateLabel.text = asDate + ")"
//            let remainDate = compareDate(asDate)
//            asView.remainedDateLabel.text = String(remainDate) + "일"
//
//            if remainDate < 0 {
//                asView.remainDateContainer.isHidden = true
//                asView.asEndTextLabel.isHidden = false
//            }
//        }
//
//        applyPostSnapshot()
...
//        }
//
//        if isWorkView || (!isWorkView && compareDate(extractDate(networkManager.roomData!.endDate)) <= 0) {
//            view.addSubview(topContainerView)
//            topContainerView.snp.makeConstraints {
//                $0.top.equalToSuperview()
//                $0.horizontalEdges.equalToSuperview()
...
//            }
//        } else if compareDate(extractDate(networkManager.roomData!.endDate)) <= 0 {
//            topContainerView.addSubview(asView)
//            asView.snp.makeConstraints {
//                $0.edges.equalToSuperview()
//            }
...
//        }
//
//        postCollectionView.contentInset.top = 16
//
//        if isWorkView || (!isWorkView && compareDate(extractDate(networkManager.roomData!.endDate)) <= 0) {
//            postCollectionView.contentInset.top += categorySectionHeight
//        }
//
//        if !isWorkView {
//            postCollectionView.contentInset.bottom = 90
...
//    }
//
//    private func compareDate(_ targetDateString: String) -> Int {
//        let dateFormatter = DateFormatter()
//        dateFormatter.dateFormat = "yyyy.MM.dd"
//        dateFormatter.timeZone = TimeZone(identifier: "KST")
//
//        guard let targetDate = dateFormatter.date(from: "20" + targetDateString) else { return -999 }
//
//
