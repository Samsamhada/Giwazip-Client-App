...
enum TextLiteral {
    ...
    static let customerServiceErrorTitle = "고객센터를 이용할 수 없습니다"
    static let customerServiceErrorMessage = "고객센터는 메일 앱이 사용 가능한 상태에만 이용할 수 있습니다.\n아이폰 기본 메일 앱이 사용 가능한 상태인지 확인해주세요."
